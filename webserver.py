...
class WebRequestHandler(BaseHTTPRequestHandler):
    ...
    # Función para que ejecute un método dependiendo de la ruta que se escogio.
    ...
    # Función par el get de la pagina
    def do_GET(self):
    ...
    # Función donde retorna el index.html para la visualización
    def get_index(self):
    ...
    # Retorna los libros dependiendo del ID seleccionado
    ...
    # Guarda en la memoria los libros que ya se leyeron (Apareceran en azul)
    ...
    # Para recuperar las cookies de los libros leidos.
    ...
    # Te muestra los demas libros que no han sido leidos.
    ...
    # Función para la información de los libros.
    ...
    # Agregar los libros a la base de datos de redis.
def set_redis_keys():
    ...
    # Se ejecuta el servidor, printeando asi server starting...
